...
public class TwoDimensionCode {
	...
	private static Log logger = LogFactory.getLog(TwoDimensionCode.class);
	 ...
	 * @param imgType 图片类型
	 */
	public static byte[] encoderQRCode(String content, String imgPath, String imgType) {
	 ...
	 * @param size 二维码尺寸
	 */
	public static byte[] encoderQRCode(String content, String imgPath, String imgType, int size) {
		try {
			BufferedImage bufImg = qRCodeCommon(content, imgType, size);
			//File imgFile = new File(imgPath);
			//ImageIO.write(bufImg, imgType, imgFile);//存放文件
			ByteArrayOutputStream output = new ByteArrayOutputStream();
			// 生成二维码QRCode图片
			ImageIO.write(bufImg, imgType, output);//存放二进制流
	...
	public static void main(String[] args) {
		String imgPath = "D:/labitu.png";
		String encoderContent = "3-1-01-01-01-01-000001-001" ;
