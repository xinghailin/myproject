...
public interface PaymentPlanMapper {
	...
	List<Bizpayplan> selectByPaytimeForPay(Bizpayplan record);
	 ...
	 List<PaymentPlanDto> selectPaymentPlaneByPaymentPlanDto(PaymentPlanDto record);
	 int countPaymentPlaneByPaymentPlanDto(PaymentPlanDto record);
	 
	 List<PaymentPlanDto> selectPaymentPlaneDetailByPaymentPlanDto(PaymentPlanDto record);
	 int countPaymentPlaneDetailByPaymentPlanDto(PaymentPlanDto record);
}